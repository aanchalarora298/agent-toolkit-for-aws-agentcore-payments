...
Read [setup-script.md](payments-setup-script.md) for the full script template. Substitute the developer's inputs and execute it.
...
Read [wiring.md](payments-wiring.md) for framework-specific tool code. Use the pattern matching the detected framework from Step 1.
